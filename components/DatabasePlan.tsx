  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setError(
          'Could not load admin data. You may not have the required permissions.'
        );
      } finally {
        setLoading(false);
      }
                ...
                <table className='w-full text-sm text-left'>
                  ...
                  <tbody>
                    {users.map(user => (
                      <tr
                        key={user.id}
                        className='bg-transparent border-b dark:border-gray-700/50 hover:bg-gray-50/50 dark:hover:bg-gray-800/50'
                      >
        ...
        >
          <Card className='bg-white/95 dark:bg-slate-900/95'>
            ...
            <CardHeader>
              ...
              <CardDescription>
                A complete log of all letter requests.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className='overflow-x-auto max-h-96'>
