      ...
      <div className='w-full max-w-4xl mx-auto mb-6'>
        <div className='bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4 flex items-center space-x-3'>
          ...
          <div className='text-sm text-red-800 dark:text-red-200'>
            <span className='font-semibold'>Admin Access Only:</span> This area is restricted to authorized administrators. All access attempts are logged.
          </div>
        </div>
      </div>
          ...
          <CardFooter className='flex flex-col gap-4 px-6'>
            ...
            {loading ? (
              <Tooltip text='Authenticating...'>
                <ShinyButton disabled className='w-full h-10 sm:h-11 bg-red-600'>
