        ...
        <CardFooter className='flex justify-between'>
          ...
          {isGenerating ? (
            ...
            <Tooltip text='Use AI to generate a professional legal letter based on your inputs'>
              <ShimmerButton onClick={handleGenerateDraft}>
                Generate AI Draft
              </ShimmerButton>
            </Tooltip>
          )}
            ...
            <div className='flex flex-col sm:flex-row gap-2 justify-end'>
              ...
              >
                <button
                  ...
                  className='flex items-center justify-center gap-2 text-sm font-medium px-4 py-2 rounded-md transition-colors border border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 disabled:opacity-50 disabled:cursor-not-allowed'
                >
                  {isExporting ? (
