...
export const PasswordResetRedirect: React.FC<PasswordResetRedirectProps> = () => {
  useEffect(() => {
      ...
      <div className="max-w-md w-full bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6 text-center">
        <div className="mb-4">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            We're setting up your password reset. If you're not automatically redirected, please wait a moment.
          </p>
        </div>
        ...
        <div className="space-y-4">
          <div className="text-sm text-gray-500 dark:text-gray-400">
            ...
            <ul className="mt-2 text-left space-y-1">
              ...
              <li>• Try copying the link and opening it in a new browser tab</li>
              <li>• Replace "127.0.0.1" with "localhost" in the URL if needed</li>
            </ul>
          </div>
