                  ...
                  <div
                    className={`flex items-center justify-center w-10 h-10 rounded-full border-2 transition-all ${
                      currentStep === step.id
                        ...
                        : index < ['form', 'timeline', 'preview'].indexOf(currentStep)
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      >
                        {Object.entries(letterTypeLabels).map(([value, label]) => (
                ...
                >
                  ...
                  <div className="bg-slate-50 rounded-lg p-6 space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <h4 className="font-medium text-slate-700 mb-1">Letter Title</h4>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <h4 className="font-medium text-slate-700 mb-1">From</h4>
                        <p className="text-slate-900">{formData.senderName}</p>
                      </div>
                      <div>
                        <h4 className="font-medium text-slate-700 mb-1">To</h4>
                        <p className="text-slate-900">{formData.recipientName}</p>
                      </div>
                    </div>

                    <div>
                      <h4 className="font-medium text-slate-700 mb-1">Address</h4>
                      <p className="text-slate-900 whitespace-pre-line">{formData.recipientAddress}</p>
                    </div>
                    ...
                    {formData.additionalInstructions && (
                      <div>
                        <h4 className="font-medium text-slate-700 mb-1">Additional Instructions</h4>
                        <p className="text-slate-900">{formData.additionalInstructions}</p>
                      </div>
                    )}
                  </div>
                </motion.div>
