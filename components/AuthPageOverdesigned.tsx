...
> = ({ className, required, children, ...props }) => (
  <label
    className={`block text-sm font-semibold text-slate-700 dark:text-slate-200 mb-2 ${className}`}
    {...props}
  >
    {children}
...
const CodeIcon = () => (
  ...
  >
    <path
      ...
      strokeLinejoin='round'
      strokeWidth={2}
      d='M7 20l4-16m2 16l4-16M6 9l-3 3 3 3m8-6l3 3-3 3'
    />
  </svg>
);
  ...
  const renderAuthForm = () => (
    ...
    >
      <div className='text-center mb-6 sm:mb-8'>
        ...
        <p className='text-slate-600 dark:text-slate-400 font-medium text-sm sm:text-base'>
          {view === 'login'
            ? 'Access your AI legal assistant'
            : 'Join the future of legal writing'}
        </p>
      </div>
