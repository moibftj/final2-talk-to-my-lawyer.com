...
export const AdminDashboard: React.FC = () => {
  ...
  const tabs = [
    ...
    { id: 'employees', label: 'Employees', icon: UserCheck, badge: employees.length },
  ];
              ...
              <div className='flex-1'>
                <div className='flex items-center space-x-4'>
                  <div className='flex-1'>
                    ...
                    {user.referred_by && (
                      <p className='text-sm text-blue-600 mt-1'>Referred by employee</p>
                    )}
                  </div>
                </div>
              </div>
        ...
        >
          <div className='flex items-center justify-between mb-4'>
            <div>
              ...
              <p className='text-sm text-gray-600'>Joined: {formatDate(employee.created_at)}</p>
            </div>
            <div className='flex space-x-2'>
              <button
