...
export const validateStripeConfig = () => {
  ...
  if (STRIPE_PUBLISHABLE_KEY.startsWith('sk_')) {
    console.warn('Warning: You are using a secret key in the frontend. This should only be used for testing.');
  }
...
export const calculateFinalPrice = (price: number, discountPercentage: number) => {
